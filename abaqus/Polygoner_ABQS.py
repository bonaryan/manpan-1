...
# Write the inout file
mdb.jobs['Job-'+current_model].writeInput()

# Save the model
mdb.saveAs(pathName='C:\\Users\\manpan\\Documents\\LTU\\HILONG\\WP-3\\truss-polygonal\\Polygoner\\abaqus\\'+current_model+'.cae')
